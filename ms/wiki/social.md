...
## Media
* [**Malaysiakini**](https://www.malaysiakini.com/) — Portal berita bebas. <Badge type="info" text="Berita" /> <Badge type="tip" text="Bebas" />
* [**Free Malaysia Today (FMT)**](https://www.freemalaysiatoday.com/) — Portal berita bebas. <Badge type="info" text="Berita" /> <Badge type="tip" text="Bebas" />
* [**The Star Online**](https://www.thestar.com.my/) — Laman dalam talian akhbar utama Malaysia. <Badge type="info" text="Berita" />
* [**Malay Mail**](https://www.malaymail.com/) — Laman dalam talian akhbar utama Malaysia. <Badge type="info" text="Berita" />
* [**BERNAMA**](https://www.bernama.com/) — Agensi Berita Nasional Malaysia yang rasmi. <Badge type="tip" text="Rasmi" /> <Badge type="info" text="Berita" />
* [**Digital News Asia**](https://www.digitalnewsasia.com/) — Memberi tumpuan kepada berita teknologi dan IT. <Badge type="info" text="Berita Teknologi" />
* [**The Edge Markets**](https://www.theedgemarkets.com/) — Portal berita perniagaan dan kewangan. <Badge type="info" text="Berita Perniagaan" />
* [**Paul Tan's Automotive News**](https://paultan.org/) — Portal berita dan ulasan automotif yang popular. <Badge type="info" text="Automotif" />
* [**Lowyat.NET**](https://www.lowyat.net/) — Portal berita teknologi dan komuniti yang komprehensif. <Badge type="info" text="Berita Teknologi" /> <Badge type="tip" text="Komuniti" />
* [**MalaysiaNow**](https://www.malaysianow.com/) — Menyediakan berita, pandangan dan wawasan mengenai hal ehwal semasa. <Badge type="info" text="Berita" />

## Komuniti
* [**WeirdKaya**](https://weirdkaya.com/) — Platform berita dan media bebas untuk golongan muda Malaysia. <Badge type="info" text="Media" />
* [**Rakyat Digital**](https://rakyatdigital.gov.my/) — Platform pendidikan untuk meningkatkan literasi digital. <Badge type="tip" text="Kerajaan" />

## Perusahaan Sosial
* [**Earth Heir**](https://earthheir.com/) — Perusahaan sosial yang diperakui perdagangan adil yang memelihara kraf warisan. <Badge type="info" text="Fesyen Beretika" />
* [**Tanoti**](https://www.tanoticrafts.com/) — Berusaha untuk memelihara seni tenunan songket tradisional dan memperkasakan wanita luar bandar. <Badge type="info" text="Warisan" />
* [**Batik Boutique**](https://www.thebatikboutique.com/) — Memperkasakan artisan terpinggir untuk mencipta fesyen adil menggunakan batik tradisional. <Badge type="info" text="Fesyen Beretika" />
* [**Picha Eats**](https://www.pichaeats.com/) — Memperkasakan pelarian dengan membolehkan mereka menyediakan dan menghantar masakan dari negara asal mereka. <Badge type="tip" text="Makanan" />
* [**Urban Hijau**](https://www.urbanhijau.org/) — Ladang organik bandar yang mempromosikan pertanian lestari dan latihan komuniti. <Badge type="tip"text="Alam Sekitar" />
