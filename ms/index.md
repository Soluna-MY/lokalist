...
hero:
  ...
  text: "Koleksi Projek Tempatan Malaysia"
  tagline: 'Dibina oleh <img src="/soluna-logo.webp" alt="Soluna Logo" class="tagline-logo"> Soluna'
  actions:
    - theme: brand
      text: Mulakan
      link: /ms/introduction
    - theme: alt
      text: Soalan Lazim
      link: /ms/faq
...
features:
  - icon: |
    ...
    title: Sosial
    link: /ms/wiki/social
    details: Terokai rangkaian sosial, aplikasi pemesejan, dan platform komuniti buatan Malaysia yang direka untuk menghubungkan orang ramai.
  - icon: |
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
